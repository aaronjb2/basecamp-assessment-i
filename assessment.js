...
// CODE HERE
var trueFaveNum; if (faveNum == 22) {trueFaveNum = true;} else {trueFaveNum = false;}
...
// CODE HERE
var notHakeem; if (myName == 'Hakeem Olajuwon') {notHakeem = false;} else {notHakeem = true;}
...
// CODE HERE
if (age > 16) {canDrive = true;} else {canDrive = false;}
...
var responseCreator = function(param){
  if (param == 'green') {colorResponse = 'Green is okay'} else if (param == 'red') {colorResponse = 'I heart red'} else {colorResponse = 'What is your favorite color?'} return colorResponse;// CODE HERE
}

// #9 Create a function called 'sum' that takes in one parameter and returns the sum of that parameter added it itself.

// CODE HERE
function sum(param) {return param + param};
...
// CODE HERE
function greeter(name, number) {return "Hi! I am " + name + " and I am " + number + " years old"};
